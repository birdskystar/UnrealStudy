...
void AABCharacter::BeginPlay()
{
	...
	if (!IsPlayerControlled())
	{
		...
		{
			AssetStreamingHandle = ABGameInstance->StreamalbeManager.RequestAsyncLoad(CharacterAssetToLoad, FStreamableDelegate::CreateUObject(this, &AABCharacter::OnAssetLoadCompleted));
		}
	}
}
